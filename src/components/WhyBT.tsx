        ...
        <motion.div style={{ x }} className="flex gap-0">
          ...
          <div className="h-screen w-screen shrink-0 flex flex-col items-center justify-center p-8 md:p-24 relative overflow-hidden group">
             ...
             <div className="relative z-10 text-center max-w-4xl mx-auto flex flex-col gap-8">
               <span className="text-bt-blue text-sm md:text-base tracking-[0.4em] uppercase font-semibold">The BEE TEE Philosophy</span>
               <h2 className="text-5xl md:text-7xl lg:text-8xl font-syne font-black text-white leading-[0.9] tracking-tighter">
                 We don't sell cars. <br />
                 <span className="text-white/20 inline-block mt-4 md:mt-6 transition-colors duration-700 hover:text-white/60">We curate excellence.</span>
               </h2>
             </div>
          ...
          {CARDS.map((card) => (
            ...
            >
              ...
              <div className="absolute -top-10 -right-10 md:top-20 md:right-32 text-[20rem] md:text-[35rem] font-syne font-black text-white/5 leading-none select-none pointer-events-none">
                0{card.id}
              </div>
              ...
              <div className="relative z-10 flex flex-col gap-6 md:gap-10 max-w-2xl w-full">
                <div className="flex items-center gap-6">
                  <div className="w-12 md:w-24 h-[1px] bg-bt-blue" />
                  <span className="text-bt-blue text-xs md:text-sm tracking-[0.3em] uppercase">{`Phase 0${card.id}`}</span>
                </div>
                <h3 className="text-5xl md:text-7xl lg:text-8xl font-syne text-white tracking-tight leading-none">
                  {card.title}.
                </h3>
